...
public class AgregarLibroFinalStage extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(AgregarLibroInicioController.class.getResource("/org/cardona/estructuras/listascirculardoble/agregar-libro-final.fxml"));
