...
public class TestListaCircular {
    ...
    // Métodos estáticos
    private static ListaCircularDoble crearLista(ListaCircularDoble lista) {
        if (lista != null) {
    ...
    private static void mostrarLista(ListaCircularDoble lista) {
        if (lista == null) {
    ...
    private static void agregarLibroInicio(ListaCircularDoble lista, Scanner sc) {
        if (lista == null) {
    ...
    private static void agregarLibroFinal(ListaCircularDoble lista, Scanner sc) {
        if (lista == null) {
            System.out.println("Primero debe crear la lista.");
            return;
        }
    ...
    private static void agregarLibroPosicion(ListaCircularDoble lista, Scanner sc) {
    ...
    private static void eliminarLibroInicio(ListaCircularDoble lista) {
        if (lista == null || lista.isEmpty()) {
    ...
    private static void eliminarLibroFinal(ListaCircularDoble lista) {
        if (lista == null || lista.isEmpty()) {
            System.out.println("Primero debe crear la lista o la lista está vacía.");
            return;
        }
    ...
    private static void eliminarLibroPosicion(ListaCircularDoble lista, Scanner sc) {
        if (lista == null || lista.isEmpty()) {
            System.out.println("Primero debe crear la lista o asegurarse de que no esté vacía.");
            return;
        }
    ...
    private static void modificarLibroPosicion(ListaCircularDoble lista, Scanner sc) {
        if (lista == null || lista.isEmpty()) {
            System.out.println("Primero debe crear la lista o la lista está vacía.");
            return;
        }
    ...
    private static void cantidadLibros(ListaCircularDoble lista) {
        if (lista == null) {
            System.out.println("Primero debe crear la lista.");
            return;
        }
    ...
    private static void vaciarLista(ListaCircularDoble lista) {
        if (lista == null) {
            System.out.println("Primero debe crear la lista.");
            return;
        }
    ...
    private static ListaCircularDoble destruirLista(ListaCircularDoble lista) {
        if (lista == null) {
            System.out.println("Primero debe crear la lista.");
            return lista;
        }
    ...
    private static void recorrerNodos(ListaCircularDoble lista, Scanner sc) {
        if (lista == null || lista.isEmpty()) {
            System.out.println("Primero debe crear la lista o asegurarse de que no esté vacía.");
            return;
        }
